...
function simplethemne_script(){
    wp_enqueue_style("bs_css","https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css");
    wp_enqueue_script("my_scripts","https://ajax.googleapis.com/ajax/libs/jquery/3.1.0/jquery.min.js", array('jquery'));
}

add_action("wp_enqueue_scripts","simplethemne_script");
/**
 * Define Constants
 */
